class Game {
  ...
  start() {
    ...
    var obstaclesPos = [
      ...
      {x:width/2-150,y:height-1300,image:obstacleImg2},      
      {x:width/2+250,y:height-1800,image:obstacleImg2},
      ...
      {x:width/2-150,y:height-4300,image:obstacleImg2},
      {x:width/2+250,y:height-4800,image:obstacleImg2},
      {x:width/2,y:height-5300,image:obstacleImg2},
      {x:width/2-180,y:height-5500,image:obstacleImg2},
    ]

    this.addSprites(combustiveis,4,combustiveisImg,0.02)
